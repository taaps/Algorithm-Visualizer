...
vector<pair<int,int>> astar(vector<vector<Coordinate*>> grid, int gridRowSize, int gridColSize, 
    pair<int,int> startIndex, pair<int,int> endIndex, SDL_Renderer* renderer, vector<vector<bool>> blockGrid);
